...
from nn_expt.system.seq2seq2seq.embedding_embedding import (
    EmbeddingEmbeddingSeq2Seq2SeqSystem,
)
...
def objective(
    ...
    *,
    ...
    seed: int | None = None,
    dir: str | Path = "./out/seq2seq2seq_embedding_embedding",
    ...
    system = EmbeddingEmbeddingSeq2Seq2SeqSystem(vocab_size, seq_len, **system_kwargs)
